...
```javascript
// Basic Information
valentineName: "Aman"                    // Your Valentine's name
...
// Love Meter Messages
loveMessages: {
    extreme: "I lovee you too bb🥹💗",  // Shows above 5000%
    high: "Awwww itnaa saaraaa?😋",              // Shows above 1000%
    normal: "Marungi☹️☹️"                           // Shows above 100%
}

// Final Celebration
celebration: {
    title: "Yayy Maza aayegaa😋",     // Celebration title
